...
if __name__ == "__main__":
    parser = ArgumentParser(
        description="Validate a JSON document against a JSON schema see https://json-schema.org"
    )
    parser.add_argument(
        "schema", help="The JSON Schema to use to validate the document"
    )
    parser.add_argument(
        "document", help="The JSON Document to validate against the schema"
    )
