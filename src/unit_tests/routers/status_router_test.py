...
class TestDeploymentStatus:
    ...
    def test_endpoint_returns_right_message_if_deployment_successful(
        ...
        mocked_settings.SDS_APPLICATION_VERSION = "dev-048783a4"
        response = client.get(self.base_url)
    ...
    def test_endpoint_returns_500_if_deployment_successful(self, mocked_settings):
        ...
        mocked_settings.SDS_APPLICATION_VERSION = None
        response = client.get(self.base_url)
