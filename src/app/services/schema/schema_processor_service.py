...
class SchemaProcessorService:
    ...
    def process_schema_metadata(self, schema_metadata: SchemaMetadata):
        ...
        self.schema_bucket_repository.store_schema_json(stored_schema_filename, schema_metadata)
    ...
    def build_next_version_schema_metadata(
        self, schema_id: str, stored_schema_filename: str, schema_metadata: SchemaMetadata
