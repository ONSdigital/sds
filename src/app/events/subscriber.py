...
class Subscriber:
    ...
    def _create_subscription(self, subscription_id: str) -> None:
        self.subscription_path = self.client.subscription_path(config.PROJECT_ID, subscription_id)
        ...
        try:
            ...
            logger.error(f"Fail to create subscription. Subscription path: {self.subscription_path} Error: {e}")
    ...
    def pull_messages_and_acknowledge(self, topic_id: str, subscription_id: str) -> list:
        """
        """
