...
COLLECTION_EXERCISE_END_SUBSCRIPTION_ID=collection-exercise-end-subscription
COLLECTION_EXERCISE_END_TOPIC_ID=collection-exercise-end-topic
...
start-cloud-dev:
	...
	export COLLECTION_EXERCISE_END_SUBSCRIPTION_ID=${COLLECTION_EXERCISE_END_SUBSCRIPTION_ID} && \
	export COLLECTION_EXERCISE_END_TOPIC_ID=${COLLECTION_EXERCISE_END_TOPIC_ID} && \
