...
def test_request_survey_id_mapping_200_response(test_client, mock_http_response):
    """
    ...
    UtilityFunctions.request_survey_id_mapping.return_value = mock_http_response(
        status_code=200,
...
def test_request_survey_id_mapping_empty_list_response(test_client, mock_http_response):
    """
...
def test_request_survey_id_mapping_404_response(test_client, mock_http_response):
    """
